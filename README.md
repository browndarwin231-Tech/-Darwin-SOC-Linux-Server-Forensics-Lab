...
[View Image](Screenshot/01-Linux-Server-Forensics-Room-Setup.png)
...
[View Image](Screenshot/02-Linux-Server-Forensics-Target-and-SSH-Credentials.png)
...
[View Image](Screenshot/03-Linux-Server-Forensics-Successful-SSH-Login.png)
...
[View Image](Screenshot/04-Linux-Server-Forensics-Apache-Log-Directory.png)
...
[View Image](Screenshot/05-Linux-Server-Forensics-Apache-Tool-Detection.png)
...
[View Image](Screenshot/06-Linux-Server-Forensics-Nmap-Apache-Requests.png)
...
[View Image](Screenshot/07-Linux-Server-Forensics-Apache-Log-Answers-Verified.png)
...
[View Image](Screenshot/08-Linux-Server-Forensics-Web-Server-Log-Review.png)
...
[View Image](Screenshot/09-Linux-Server-Forensics-Web-Server-Analysis-Completed.png)
...
[View Image](Screenshot/10-Linux-Server-Forensics-Cron-Backdoor-Verified.png)
...
[View Image](Screenshot/11-Linux-Server-Forensics-Root2-Password-Verified.png)

### 12. Second VM Deployment

Deployed a second compromised Linux server to continue the forensic investigation.

[View Image](Screenshot/12-Linux-Server-Forensics-Second-VM-Deployed.png)
...
This demonstrated how scanner activity can still be detected even when obvious user-agent indicators are absent.

[View Image](Screenshot/13-Linux-Server-Forensics-Apache-Log-Analysis-II-Completed.png)
...
[View Image](Screenshot/14-Linux-Server-Forensics-SSH-Key-Persistence-Verified.png)
...
[View Image](Screenshot/15-Linux-Server-Forensics-Program-Execution-History.png)
...
[View Image](Screenshot/16-Linux-Server-Forensics-Root-Bash-History.png)

### 17. Lab Completed

The TryHackMe Linux Server Forensics room was successfully completed at **100%**.

The investigation covered multiple stages of a Linux compromise, including reconnaissance, suspicious web activity, persistence, privileged account manipulation, SSH access, and command-history analysis.

[View Image](Screenshot/17-Linux-Server-Forensics-Lab-Completed.png)
